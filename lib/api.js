...
var getModuleRoute = function(fn) {
  return function(req, res, next) {
    var result = fn.apply(module, req.body);
    res.json(result);
  }
}
...
API.prototype.module = function() {
  ...
  for (var key in module) {
    ...
    if (typeof fn === 'function') {
      ...
      self.router.post(fnPath, getModuleRoute(fn));
      self.router.post(fnPath, function(req, res, next) {
      }, arguments)
    }
  }
}
